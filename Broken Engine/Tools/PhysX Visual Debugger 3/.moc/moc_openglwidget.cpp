...
#include "../../../../PVDNext/openglwidget.h"
...
QT_MOC_LITERAL(1, 13, 13), // "renderCtxMenu"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 41, 5), // "event"
QT_MOC_LITERAL(5, 47, 13), // "cameraUpdated"
QT_MOC_LITERAL(6, 61, 15), // "onMessageLogged"
QT_MOC_LITERAL(7, 77, 19), // "QOpenGLDebugMessage"
QT_MOC_LITERAL(8, 97, 7) // "message"

    },
    "OpenGLWidget\0renderCtxMenu\0\0QMouseEvent*\0"
    "event\0cameraUpdated\0onMessageLogged\0"
    "QOpenGLDebugMessage\0message"
};
...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->renderCtxMenu((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        case 1: _t->cameraUpdated(); break;
        ...
        {
            typedef void (OpenGLWidget::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWidget::renderCtxMenu)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWidget::cameraUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void OpenGLWidget::renderCtxMenu(QMouseEvent * _t1)
{
...
// SIGNAL 1
void OpenGLWidget::cameraUpdated()
{
