...
function MovementInputs ()	--Process Movement Inputs
	...
	then
		...
		lua_table.Functions:LOG("MOV SPEED X: "..mov_speed_x)
		lua_table.Functions:LOG("MOV SPEED Z: "..mov_speed_z)
		lua_table.Functions:LOG("x".._x)
		lua_table.Functions:LOG("z".._z)
